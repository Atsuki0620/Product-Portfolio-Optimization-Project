...
- [ ] フォルダ構成が定義通りに作成されている
- [ ] config.yaml、schema.mdが作成されている
- [ ] 代理店モデルが反映されたsales_2024.csvが生成されている（複数セグメント顧客40%）
- [ ] product_masterに顧客コードが追加されている
- [ ] 最適化コードが4つ組タプルに対応している
- [ ] A-3〜A-7の5つの改善提案がすべて実装されている
- [ ] Step 1〜4がエラーなく実行できる
- [ ] 最適化が成功し、結果が妥当である
- [ ] レポートが作成されている
...
本計画書の内容で問題なければ、**フェーズ1: 基盤整備**から実装を開始します。
